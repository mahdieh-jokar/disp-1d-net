...
(* CORE_GENERATION_INFO="ConvolutionInputGenerator1D_3_ConvolutionInputGenerator1D_3,hls_ip_2019_1,{HLS_INPUT_TYPE=cxx,HLS_INPUT_FLOAT=0,HLS_INPUT_FIXED=1,HLS_INPUT_PART=xc7a200t-fbg484-3,HLS_INPUT_CLOCK=10.000000,HLS_INPUT_ARCH=others,HLS_SYN_CLOCK=5.845000,HLS_SYN_LAT=72,HLS_SYN_TPT=none,HLS_SYN_MEM=0,HLS_SYN_DSP=0,HLS_SYN_FF=989,HLS_SYN_LUT=861,HLS_VERSION=2019_1}" *)

module ConvolutionInputGenerator1D_3_ConvolutionInputGenerator1D_3 (
        ap_clk,
        ap_rst_n,
        in0_V_V_TDATA,
        in0_V_V_TVALID,
...
reg   [191:0] out_V_V_1_data_out;
wire    out_V_V_1_vld_in;
wire    out_V_V_1_vld_out;
wire    out_V_V_1_ack_in;
wire    out_V_V_1_ack_out;
reg   [191:0] out_V_V_1_payload_A;
reg   [191:0] out_V_V_1_payload_B;
...
wire   [191:0] grp_ConvolutionInputGene_1_fu_26_out_V_V_TDATA;
...
ConvolutionInputGenerator1D_3_ConvolutionInputGene_1 grp_ConvolutionInputGene_1_fu_26(
    .ap_clk(ap_clk),
    .ap_rst(ap_rst_n_inv),
...
endmodule //ConvolutionInputGenerator1D_3_ConvolutionInputGenerator1D_3
