...
(* CORE_GENERATION_INFO="FMPadding_Batch_0_FMPadding_Batch_0,hls_ip_2019_1,{HLS_INPUT_TYPE=cxx,HLS_INPUT_FLOAT=0,HLS_INPUT_FIXED=1,HLS_INPUT_PART=xc7a200t-fbg484-3,HLS_INPUT_CLOCK=10.000000,HLS_INPUT_ARCH=others,HLS_SYN_CLOCK=3.212250,HLS_SYN_LAT=72,HLS_SYN_TPT=none,HLS_SYN_MEM=0,HLS_SYN_DSP=0,HLS_SYN_FF=65,HLS_SYN_LUT=282,HLS_VERSION=2019_1}" *)
...
wire   [7:0] grp_FMPadding_nonsquare_s_fu_26_out_V_V_TDATA;
...
FMPadding_Batch_0_FMPadding_nonsquare_s grp_FMPadding_nonsquare_s_fu_26(
    .ap_clk(ap_clk),
    .ap_rst(ap_rst_n_inv),
