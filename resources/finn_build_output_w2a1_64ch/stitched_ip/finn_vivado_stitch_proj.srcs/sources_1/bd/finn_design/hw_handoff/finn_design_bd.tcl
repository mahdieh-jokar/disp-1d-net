...
proc create_hier_cell_StreamingFCLayer_Batch_3 { parentCell nameHier } {
  ...
  set_property -dict [ list \
   CONFIG.MEM_DEPTH {1} \
   CONFIG.MEM_INIT {/tmp/finn_dev_jokar/code_gen_ipgen_StreamingFCLayer_Batch_3_lw7df92t/} \
   CONFIG.MEM_WIDTH {96} \
   CONFIG.NSTREAMS {1} \
   CONFIG.RAM_STYLE {auto} \
   CONFIG.STRM0_DEPTH {1} \
...
proc create_hier_cell_StreamingFCLayer_Batch_2 { parentCell nameHier } {
  ...
  set_property -dict [ list \
   CONFIG.MEM_DEPTH {1} \
   CONFIG.MEM_INIT {/tmp/finn_dev_jokar/code_gen_ipgen_StreamingFCLayer_Batch_2_aqd1y8fw/} \
   CONFIG.MEM_WIDTH {768} \
   CONFIG.NSTREAMS {1} \
   CONFIG.RAM_STYLE {auto} \
   CONFIG.STRM0_DEPTH {1} \
   CONFIG.STRM0_OFFSET {0} \
   CONFIG.STRM0_WIDTH {768} \
...
proc create_hier_cell_StreamingFCLayer_Batch_1 { parentCell nameHier } {
  ...
  set_property -dict [ list \
   CONFIG.MEM_DEPTH {1} \
   CONFIG.MEM_INIT {/tmp/finn_dev_jokar/code_gen_ipgen_StreamingFCLayer_Batch_1_jyi0q7y_/} \
   CONFIG.MEM_WIDTH {768} \
   CONFIG.NSTREAMS {1} \
   CONFIG.RAM_STYLE {auto} \
   CONFIG.STRM0_DEPTH {1} \
...
proc create_hier_cell_StreamingFCLayer_Batch_0 { parentCell nameHier } {
  ...
  set_property -dict [ list \
   CONFIG.MEM_DEPTH {1} \
   CONFIG.MEM_INIT {/tmp/finn_dev_jokar/code_gen_ipgen_StreamingFCLayer_Batch_0_r2l81l2y/} \
   CONFIG.MEM_WIDTH {96} \
   CONFIG.NSTREAMS {1} \
   CONFIG.RAM_STYLE {auto} \
   CONFIG.STRM0_DEPTH {1} \
...
proc create_root_design { parentCell } {
  ...
  # Create instance: ConvolutionInputGenerator1D_3, and set properties
  set ConvolutionInputGenerator1D_3 [ create_bd_cell -type ip -vlnv xilinx.com:hls:ConvolutionInputGenerator1D_3:1.0 ConvolutionInputGenerator1D_3 ]
  ...
  # Create interface connections
  connect_bd_intf_net -intf_net ConvolutionInputGenerator1D_0_out_V_V [get_bd_intf_pins ConvolutionInputGenerator1D_0/out_V_V] [get_bd_intf_pins StreamingFCLayer_Batch_0/in0_V_V]
  connect_bd_intf_net -intf_net ConvolutionInputGenerator1D_1_out_V_V [get_bd_intf_pins ConvolutionInputGenerator1D_1/out_V_V] [get_bd_intf_pins StreamingFCLayer_Batch_1/in0_V_V]
  connect_bd_intf_net -intf_net ConvolutionInputGenerator1D_2_out_V_V [get_bd_intf_pins ConvolutionInputGenerator1D_2/out_V_V] [get_bd_intf_pins StreamingFCLayer_Batch_2/in0_V_V]
  connect_bd_intf_net -intf_net ConvolutionInputGenerator1D_3_out_V_V [get_bd_intf_pins ConvolutionInputGenerator1D_3/out_V_V] [get_bd_intf_pins StreamingFCLayer_Batch_3/in0_V_V]
  connect_bd_intf_net -intf_net FMPadding_Batch_0_out_V_V [get_bd_intf_pins ConvolutionInputGenerator1D_0/in0_V_V] [get_bd_intf_pins FMPadding_Batch_0/out_V_V]
  connect_bd_intf_net -intf_net FMPadding_Batch_1_out_V_V [get_bd_intf_pins ConvolutionInputGenerator1D_1/in0_V_V] [get_bd_intf_pins FMPadding_Batch_1/out_V_V]
  connect_bd_intf_net -intf_net FMPadding_Batch_2_out_V_V [get_bd_intf_pins ConvolutionInputGenerator1D_2/in0_V_V] [get_bd_intf_pins FMPadding_Batch_2/out_V_V]
  connect_bd_intf_net -intf_net FMPadding_Batch_3_out_V_V [get_bd_intf_pins ConvolutionInputGenerator1D_3/in0_V_V] [get_bd_intf_pins FMPadding_Batch_3/out_V_V]
  connect_bd_intf_net -intf_net StreamingFCLayer_Batch_0_out_V_V [get_bd_intf_pins FMPadding_Batch_1/in0_V_V] [get_bd_intf_pins StreamingFCLayer_Batch_0/out_V_V]
  connect_bd_intf_net -intf_net StreamingFCLayer_Batch_1_out_V_V [get_bd_intf_pins FMPadding_Batch_2/in0_V_V] [get_bd_intf_pins StreamingFCLayer_Batch_1/out_V_V]
  connect_bd_intf_net -intf_net StreamingFCLayer_Batch_2_out_V_V [get_bd_intf_pins FMPadding_Batch_3/in0_V_V] [get_bd_intf_pins StreamingFCLayer_Batch_2/out_V_V]
  ...
  # Create port connections
  connect_bd_net -net ap_clk_0_1 [get_bd_ports ap_clk] [get_bd_pins ConvolutionInputGenerator1D_0/ap_clk] [get_bd_pins ConvolutionInputGenerator1D_1/ap_clk] [get_bd_pins ConvolutionInputGenerator1D_2/ap_clk] [get_bd_pins ConvolutionInputGenerator1D_3/ap_clk] [get_bd_pins FMPadding_Batch_0/ap_clk] [get_bd_pins FMPadding_Batch_1/ap_clk] [get_bd_pins FMPadding_Batch_2/ap_clk] [get_bd_pins FMPadding_Batch_3/ap_clk] [get_bd_pins StreamingFCLayer_Batch_0/ap_clk] [get_bd_pins StreamingFCLayer_Batch_1/ap_clk] [get_bd_pins StreamingFCLayer_Batch_2/ap_clk] [get_bd_pins StreamingFCLayer_Batch_3/ap_clk] [get_bd_pins StreamingFIFO_0/ap_clk]
  connect_bd_net -net ap_rst_n_0_1 [get_bd_ports ap_rst_n] [get_bd_pins ConvolutionInputGenerator1D_0/ap_rst_n] [get_bd_pins ConvolutionInputGenerator1D_1/ap_rst_n] [get_bd_pins ConvolutionInputGenerator1D_2/ap_rst_n] [get_bd_pins ConvolutionInputGenerator1D_3/ap_rst_n] [get_bd_pins FMPadding_Batch_0/ap_rst_n] [get_bd_pins FMPadding_Batch_1/ap_rst_n] [get_bd_pins FMPadding_Batch_2/ap_rst_n] [get_bd_pins FMPadding_Batch_3/ap_rst_n] [get_bd_pins StreamingFCLayer_Batch_0/ap_rst_n] [get_bd_pins StreamingFCLayer_Batch_1/ap_rst_n] [get_bd_pins StreamingFCLayer_Batch_2/ap_rst_n] [get_bd_pins StreamingFCLayer_Batch_3/ap_rst_n] [get_bd_pins StreamingFIFO_0/ap_rst_n]
